...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        Order savedResult = saveOrder(order);

        log.info("Order is created with id: {}", savedResult.getId().getValue());
        return orderDataMapper.orderToCreateOrderResponse(savedResult);
    }
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        if (optionalRestaurant.isEmpty()) {
            ...
            throw new OrderDomainException("Could not find restaurant with restaurantId: " + createOrderCommand.getRestaurantId());
        }
    ...
    private Order saveOrder(Order order) {
        ...
        log.info("Order is saved with Id: {}", resultOrder.getId().getValue());
        return resultOrder;
    }
}
